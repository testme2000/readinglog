...
describe('Update Book Entry Basic Component Test', () => {
    it('Update Book Entry Basic comppoent Verification', () => {
        const wrapper = shallowMount(updatebookentry, {
                propsData: {
                    entry : {
        ...
        expect(wrapper.name()).to.equal("updatebookentry");
    })

    describe('Update Book Entry User Interface test', () => {
        it('Update Book Entry user interface layout', () => {
            const wrapper = shallowMount(updatebookentry,{
                propsData: {
                    entry : {
                        internalId: "5ecbb9989cb1f54bd8146130",
            ...
            expect(h1.text()).to.equal("Update Booklog Entry");
            ...
            expect(mdActButton.text()).to.equal("Update Book");
        })
    });
});

describe('Update Book Entry Data Test', () => {
    it('Update Book Entry Data Verification', () => {
        const wrapper = shallowMount(updatebookentry,{
            propsData: {
                entry : {
                    internalId: "5ecbb9989cb1f54bd8146130",
...
describe('Update Book Entry Method Test', () => {
    it('Update Book Entry Method Status Clear Verification', () => {
        var e = {
          preventDefault: () => {
    ...
    it('Update Book Entry Method Error Verification', () => {
        var e = {
          preventDefault: () => {
